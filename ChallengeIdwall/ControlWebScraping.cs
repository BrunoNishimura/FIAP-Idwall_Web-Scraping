...
namespace ChallengeIdwall.WebScraping
{
    public class ControlWebScraping
    {
        Dictionary<string, Action> Exercicios;

        public enum Section { Introducao, Configuracao, Fundamentos }
        public ControlWebScraping(Dictionary<string, Action> exercicios)
        {
